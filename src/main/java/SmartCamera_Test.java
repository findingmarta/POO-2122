...
public class SmartCamera_Test {
    ...
    public void testConstructor(){
        ...
        smartCam1 = new SmartCamera("cam1",1080.0,200.30);
        assertNotNull(smartCam1);
    }

    @Test
    public void testGetSize (){
        SmartCamera smartCam1 = new SmartCamera("cam1",1034.0,150.1);
        assertEquals(150.1, smartCam1.getSize());
        smartCam1 = new SmartCamera("cam1",230.98,190.0);
    ...
    public void testSetSize (){
        SmartCamera smartCam1 = new SmartCamera("cam1",1034.1,150.1);
    ...
    public void testGetResolution (){
        SmartCamera smartCam1 = new SmartCamera("cam1",2080.4,222.1);
        assertEquals(2080.4, smartCam1.getResolution());
        smartCam1 = new SmartCamera("cam1",109.7,99.12);
        assertEquals(109.7, smartCam1.getResolution());
    }

    @Test
    public void testSetResolution (){
        SmartCamera smartCam1 = new SmartCamera("cam1",1066.0,603.1);
    ...
    public void testConsumoEnergia (){
        SmartCamera smartCam1 = new SmartCamera("cam1",200.0,35.1);
        assertEquals(7023, smartCam1.consumoEnergia());
        smartCam1 = new SmartCamera("cam1",140.2,60.0);
